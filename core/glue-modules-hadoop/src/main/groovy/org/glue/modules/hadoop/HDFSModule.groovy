...
public interface HDFSModule extends GlueModule {
	...
	void findNewFiles(String file, Closure dirHasBeenModified, Closure closure)
	void findNewFiles(String clusterName, String file, Closure dirHasBeenModified, Closure closure)
	 ...
	 * @throws IOException
	 */
	void eachLine(String file, boolean recursive, Closure closure)
			throws IOException;
